-- WIS-PERSONNEL-RBAC-01: Add SUPPORT role permissions and policies
-- TRANSACTION SAFETY: Uses SUPPORT enum value added in 20260926000000_add_support_role.sql
-- Must run AFTER enum migration has committed
